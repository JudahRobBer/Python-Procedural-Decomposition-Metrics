...
def info_for_plants(circle_area: float, plant_spacing: float) -> None: 
...
def info_for_fill(side_len: float, circle_area: float, fill_depth: float) -> None:
...
def info_for_soil(circle_area: float, soil_depth: float) -> None:
...
def main() -> None:
    ...
    area = get_circle_area(side_len)
    info_for_plants(area, plant_spacing)
    info_for_fill(side_len, area, fill_depth)
    info_for_soil(area, soil_depth)
