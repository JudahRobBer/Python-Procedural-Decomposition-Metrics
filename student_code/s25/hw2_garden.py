...
def circle_area(side_len: float, plant_spacing: float) -> float:
    pi = 3.14
...
def circle_soil(circle_area, soil_depth) -> None:
...
def main() -> None:
    ...
    a = circle_area(side_len, plant_spacing)
    circle_soil(a,soil_depth)
    fill_area(side_len,a,fill_depth)
