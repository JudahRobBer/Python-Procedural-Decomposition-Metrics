...
def circle_area(side_len:float) -> None:
    pi = 3.14
    circle_area = pi * (side_len/4)**2
    return circle_area

#calculate plants(as a group)
...
def main() -> None:
    ...
    fill(side_len,circle_area(side_len),fill_depth)
