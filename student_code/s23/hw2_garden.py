...
# the first function takes the return value from function circle_area and a user input and calculates everything relating to plants
def plants(circle_area:float, plant_spacing:float) -> None:
 ...
 # the second function takes circle_area and another user input and calculates everthing relating to soil
...
#the third function takes two user inputs and circle_area and calculates everthing relating to fill
...
# the function calculates the circle area of the middle garden and returns a value that will be used in the other three sub-functions
def circle_area_garden(side_len:float) -> float:
    pi = 3.14
    circle_area = pi * (side_len/4)**2
    return circle_area
    
# the main function takes all the input from the user and then captures the value from function _circle_area_garden and uses this as the parameters when calling the other three functions
def main() -> None:
    ...
    circle_area_garden(side_len)
    circle_area = circle_area_garden(side_len)
