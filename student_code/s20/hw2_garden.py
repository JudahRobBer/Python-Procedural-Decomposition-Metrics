...
#functions grouped by calculations involving plants
def plants(side_len:float, plant_spacing:float)->int:
    pi = 3.14
...
#functions grouped by calculations involving fill
...
#functions grouped by calculations involving soil
...
def main():
    ...
    circle_area = plants(side_len,plant_spacing)
