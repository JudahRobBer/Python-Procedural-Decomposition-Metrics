...
def body (side_len: float,plant_spacing:float) -> int:
    pi = 3.14
...
def body_2 (side_len:float,circle_area:float,fill_depth:float) -> None:
...
def body_3 (circle_area:float,soil_depth:float) -> None:
...
def main() -> None:
    ...
    body_3(circle_area, soil_depth)
    body_2(side_len,circle_area,fill_depth)
