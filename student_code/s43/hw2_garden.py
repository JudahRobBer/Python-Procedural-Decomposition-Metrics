...
def circle_area(side_len: float) -> float:
    ...
    return circle_area
def fill_area(side_len: float, circle_area: float, fill_depth: float) -> None:
...
def total_plants(circle_area: float, plant_spacing: float) -> None:
...
def circle_soil(circle_area: float, soil_depth: float) -> None:
...
def main() -> None:
    ...
    total_plants(circle_area(side_len), plant_spacing)
    fill_area(side_len, circle_area(side_len), fill_depth)
    circle_soil(circle_area(side_len), soil_depth)
