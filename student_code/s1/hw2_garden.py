...
def plants(side_len:float,plant_spacing:float) -> float:
    pi = 3.14
...
def fill(side_len:float,circle_area:float,fill_depth:float,soil_depth:float) -> float:
...
def main () -> None:
    ...
    fill(side_len, circle_area, fill_depth,soil_depth)
